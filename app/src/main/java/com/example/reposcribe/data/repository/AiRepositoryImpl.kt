...
//            generationConfig = GenerationConfig(responseMineType = "application/json")
        ...
        Log.d("AiRepositoryImpl", "AI request body: ${Gson().toJson(aiRequest)}")
        try {
            //call API
            ...
            val summaryText = response.candidates
                ...
                ?: "No response"
            Log.d("AiRepositoryImpl", "Raw AI response: ${summaryText.take(1000)}")
            ...
            return try {
                ...
                Log.e("AiRepositoryImpl", "Gson parse error, returning empty PromptResponse", e)
                PromptResponse()  //fallback empty
            }

        } catch (e: Exception) {
            Log.e("AiRepositoryImpl", "AI request error", e)
