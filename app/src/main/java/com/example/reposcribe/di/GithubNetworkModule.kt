...
import com.example.reposcribe.annotation.GithubOkHttp
import com.example.reposcribe.annotation.GithubRetrofit
...
object GithubNetworkModule {
    ...
    @Singleton
    @GithubRetrofit
    fun provideRetrofit(@GithubOkHttp okHttpClient: OkHttpClient): Retrofit {
